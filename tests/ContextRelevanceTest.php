...
test('uses the right prompts', function () {
    ...
    expect($systemPrompt)
        ->toBeString()
        ->toBe(view('llm-monitoring::context-relevance.system', $data->toArray())->render());
    expect($userPrompt)
        ->toBeString()
        ->toBe(view('llm-monitoring::context-relevance.user', $data->toArray())->render())
